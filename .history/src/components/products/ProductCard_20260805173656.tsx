    ...
    return (
      ...
      >
        ...
        <div className="mt-auto flex items-center justify-between gap-3 border-t border-slate-100 pt-3 dark:border-neutral-800">
          <span className="inline-flex items-center justify-center rounded-full bg-indigo-100 px-2.5 py-1 text-xs font-semibold text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300">
            {formatQuantity(product.cantidad)} und
          </span>
          <time
            dateTime={product.creacion}
            className="text-right text-xs text-slate-400 dark:text-neutral-500"
